...
IncidentResponseReceiver::IncidentResponseReceiver(
...
{
    std::cout << "[Receiver] Processing dispatch request."
              << std::endl;
...
{
    std::cout << "[Receiver] Processing evacuation request."
              << std::endl;
...
{
    std::cout << "[Receiver] Processing alert request."
              << std::endl;
...
{
    std::cout << "[Receiver] Processing cancellation request."
              << std::endl;
